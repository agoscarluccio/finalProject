# -*- coding: utf-8 -*-
"""
Created on Tue Apr 19 20:43:18 2022
...
def startGame():
    ...
    print('Welcome to Hangman! Do you want to play? (yes or no)')
...
# This checks to see if the player guessed too many times and lost.
...
# When the game is done this asks the player if they want to play again.
     if gameIsDone:
         if playAgain():
             incorrectLetters = ''
             correctLetters = ''
